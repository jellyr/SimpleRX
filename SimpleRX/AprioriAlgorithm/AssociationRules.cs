...
namespace AprioriAlgorithm
{
    public class AssociationRules
    {
        ...
        public List<AssociationItem> CalcuateAssoctionRules(List<Item> fromList, List<Item> toList, IEnumerable<IEnumerable<string>> transactions)
        {
        ...
        public void CountItem(Item item, IEnumerable<IEnumerable<string>> transactions)
        {
